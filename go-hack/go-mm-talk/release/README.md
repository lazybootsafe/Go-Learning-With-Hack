...
# https://github.com/lazybootsafe/Go-Learning-With-Hack/tree/master/hack/go-mm-talk/releases 自行下载 wget http://
# 解压到当前目录
...
# https://github.com/lazybootsafe/Go-Learning-With-Hack/tree/master/hack/go-mm-talk/releases 自行下载
# 手动解压到当前目录
# 进入 install 目录
# 双击点开 install.exe 文件
# 浏览器访问 http://ip:8090 进入安装界面，完成安装配置
